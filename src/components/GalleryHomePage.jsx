...
function GalleryHomePage() {
  ...
  return (
    <section
      className="relative w-full min-h-screen bg-cover bg-gallery-bg bg-center flex items-center"
      id="gallery"
    >
      ...
      {selectedPost && (
        <div className="modal">
          <div className="modal-content mx-0 my-20 lg:m-[34rem] xl:m-[46rem] bg-color-1">
